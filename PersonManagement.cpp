...
bool menu_loop(bool, Person*, Person*, Person*);
...
void add_bulkPerson(Person*, Person*, Person*);
...
int main() {
    ...
    while (quit == false && cin) {
        ...
        quit = menu_loop(quit, head, current, newPerson);  //  Exit on flag
    }
    ...
    while (cin && dontQuitMenu == true) {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                add_bulkPerson(current, newPerson, head);
...
// Parameters: String, Person*, Person*, Person*
// Returns: Void
void add_bulkPerson(Person* current, Person* newPerson, Person* head) {
